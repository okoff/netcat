  				...
  				<td>
  					<table class='admin_table' width=100%>
  						<tr>
  							...
  							<td align=center><div class='icons icon_type_bool' title='".CONTROL_CONTENT_CATALOUGE_FUNCS_SHOWCATALOGUELIST_DELETE."'></div></td>
  						</tr>";
...
" . (!$comment['Checked'] ? "style='color:#cccccc;'>" . nc_bbcode($comment['Comment']) :
    	...
    	<td align=center><input type=checkbox name='comment" . $comment['id'] . "' value=" . $comment['Sub_Class_ID'] . "></td>
    	</tr>
    	";
    }
  ...
  public function subscribe_settings() {
    ...
    // subscribe link
    echo nc_admin_textarea(NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_SETTINGS_BLOCK, 'Subscribe_Block', $settings['Subscribe_Block'], 1, 0, 'width:100%; height:1.5em; line-height:1.1em');
    // mail subject
    ...
    // mail template
    echo nc_admin_textarea(NETCAT_MODULE_COMMENTS_ADMIN_SUBSCRIBE_SETTINGS_MAIL_TEMPLATE, 'Mail_Template', $settings['Mail_Template'], 1, 0, 'width:100%; height:7em; line-height:1.1em');
    echo "</fieldset>\n";
  ...
  public function settings_save() {
    ...
    $params = array('GuestName', 'GuestNameForced', 'GuestEmail', 'GuestEmailForced',
        'ShowAddBlock', 'Highlight', 'ShowButton', 'Order', 'BBcode', 'UseCaptcha' , 'Qty', 'ShowAll');
