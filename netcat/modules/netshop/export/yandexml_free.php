    ...
    public function ExportYML($section=0) {
        ...
        foreach ($structure as $row) {
			...
			if (($row["Subdivision_ID"]!=81)
					&&($row["Subdivision_ID"]!=141)
					&&($row["Subdivision_ID"]!=103)
					&&($row["Subdivision_ID"]!=138)
					&&($row["Subdivision_ID"]!=102)
					&&($row["Subdivision_ID"]!=139)
					//&&($row["Subdivision_ID"]!=106)
					&&($row["Subdivision_ID"]!=109)
					&&($row["Subdivision_ID"]!=147)
					&&($row["Subdivision_ID"]!=151)
					&&($row["Subdivision_ID"]!=153)
					&&($row["Subdivision_ID"]!=157)
					&&($row["Subdivision_ID"]!=161)
					&&($row["Subdivision_ID"]!=280)
					&&($row["Subdivision_ID"]!=108)
					&&($row["Subdivision_ID"]!=131)
					
				) {
				$ret .= "<category id=\"{$row['Subdivision_ID']}\"";

				if (array_key_exists($row['Parent_Sub_ID'], $structure)) {
					if (($row['Parent_Sub_ID']!=81)&&($row['Parent_Sub_ID']!=108)) {
