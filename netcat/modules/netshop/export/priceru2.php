...
*/
        ...
        $structure = $this->GetStructureCategories($section, $catalogue,
			"( NOT `Subdivision`.`Subdivision_ID`=81 AND NOT `Subdivision`.`Parent_Sub_ID`=81 AND NOT `Subdivision`.`Subdivision_ID`=108 OR `Subdivision`.`Parent_Sub_ID`=1041) ");
