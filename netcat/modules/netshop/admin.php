...
require_once ($MODULE_FOLDER."netshop/ui_config.php");
...
header("Location: ".$SUB_FOLDER.$HTTP_ROOT_PATH."modules/netshop/import.php");

/*
  print "<a href='setup.php'>".NETCAT_MODULE_NETSHOP_SETUP."</a><br><br>
  <a href='import.php'>".NETCAT_MODULE_NETSHOP_IMPORT_COMMERCEML."</a>";
 */
