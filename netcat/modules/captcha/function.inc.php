...
function nc_captcha_image($captcha_hash) {
    ...
    for ($i = 0; $i < $num_chars; $i++) {
        //$font_size = $img_height * round(rand(30, 90) / 100, 1);
		$font_size = $img_height * round(rand(45, 70) / 100, 2);
        $text_color = imagecolorallocate($captcha_image, rand(80, 120), rand(60, 120), rand(60, 120));
