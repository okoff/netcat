...
<script type='text/javascript'>
    ...
    public function get_auth_form_v($params) {
        ...
        $r .= "<div><input type='submit' title='".htmlspecialchars_decode($params['submit_name'])."' value='".htmlspecialchars_decode($params['submit_name'])."' class='auth_submit'></div>";
        $r .= "</form>";
        $r .= "%vk_form %fb_form %twitter_form %openid_form %token_form";
    ...
    public function get_auth_form_t($params) {
        ...
        $r .= " <tr><td /><td><input class='auth_submit' type='submit' title='".htmlspecialchars_decode($params['submit_name'])."' value='".htmlspecialchars_decode($params['submit_name'])."'></td></tr>";
