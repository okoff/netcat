...
define("NETCAT_MODULE_AUTH_ADMIN_INFO", "Вы можете настроить отображение списка пользователей, а также структуры таблицы \"Пользователи\" в разделе \"<a href=/netcat/admin/field/system.php>Системные таблицы</a>\".<br/>");
...
define("NETCAT_MODULE_AUTH_ADMIN_SYSTEM_CC_USER_LIST", "Компонент в разделе с пользователями");
...
");
define("NETCAT_MODULE_AUTH_USER_AGREEMENT", "Я согласен с <a target='_blank' href='%USER_AGR'>офертой предоставления услуг</a>");
define("NETCAT_MODULE_AUTH_USER_AGREEMENTT", "Я ознакомлен с <a target='_blank' href='%USER_AGR'>положением о защите персональных данных</a>");
?>