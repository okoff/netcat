...
define("NETCAT_MODULE_SEARCH_ADMIN_DATA_EXTRACTION_FIELD_IS_TOKENIZED", "нормализовывать текст");
...
define("NETCAT_MODULE_SEARCH_ADMIN_EVENT_INDEXING_CONTENT_ERROR", "Ошибка при индексации документа");
...
define("NETCAT_MODULE_SEARCH_MB_OVERLOAD_ENABLED_ERROR", "Для работы модуля необходимо отключть перезагрузку строковых функций ".
...
define("NETCAT_MODULE_SEARCH_PCRE_UTF_ERROR", "Для работы модуля необходима поддержка работы регулярных выражений в кодировке UTF-8. ".
        "При комиляции PHP следует использовать встроенную библиотеку PCRE или библиотеку PCRE, скомпилированную с опцией <i>--enable-unicode-properties</i>.");
