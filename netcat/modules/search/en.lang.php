...
define("NETCAT_MODULE_SEARCH_ADMIN_STAT_CHECK_CRONTAB",
        "There are outstanding tasks in queue of indexing. Check that cron can run your re-indexing script.");
...
define("NETCAT_MODULE_SEARCH_ADMIN_DATA_EXTRACTION_FIELD_IS_TOKENIZED", "text normalize");
...
define("NETCAT_MODULE_SEARCH_ADMIN_EVENT_LOG_SETTINGS", "Event log preferences");
...
define("NETCAT_MODULE_SEARCH_ADMIN_EVENT_PARSER_DOCUMENT_BRIEF", "Short  information about the received document");
...
// Общие
define("NETCAT_MODULE_SEARCH_DATETIME_FORMAT", "%m.%d.%Y %H:%M");
