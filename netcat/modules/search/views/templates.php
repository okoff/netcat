...
<form method="POST" class="settings">
    ...
    <fieldset>
        <legend><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_RESULTS
?></legend>
...
?>' />
    ...
    <?=$this->setting_cb('EnableAdvancedSearchForm', NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_ENABLE_ADVANCED_SEARCH_FORM) ?>
        <div class="setting">
            <div class="caption"><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_ADVANCED_SEARCH_FORM_OPTIONS
?>:</div>
            <blockquote>
...
?>
    ...
    <fieldset>
        <legend><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_QUERY_SUGGEST
?></legend>
        <div class="setting">
            <input type="radio" name="s[SuggestMode]" value="queries" id="r_s1"
          <?=($suggest_enabled && $suggest_mode == 'queries' ? " checked" : "") ?>/>
            <label for="r_s1"><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_QUERY_SUGGEST_QUERIES
?></label>
        </div>
        <div class="setting">
...
?>/>
                   <label for="r_s2"><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_QUERY_SUGGEST_TITLES
?></label>
               </div>
               <div class="setting">
...
?>/>
                   <label for="r_s3"><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_QUERY_SUGGEST_DISABLED
?></label>
               </div>
               <div class="setting">
...
?>' />
           ...
           <fieldset>
               <legend><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_FORM_TEMPLATES
?></legend>
               <textarea class="code"
                         name="web_SearchFormTemplate"><?=htmlspecialchars(nc_search::get_setting('web_SearchFormTemplate'))
?></textarea>
           </fieldset>

           <fieldset>
               <legend><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_ADVANCED_FORM_TEMPLATE
?></legend>
               <textarea class="code"
                         name="web_AdvancedSearchFormTemplate"><?=htmlspecialchars(nc_search::get_setting('web_AdvancedSearchFormTemplate'))
?></textarea>
    </fieldset>
               <fieldset>
               <legend><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_FORM_TEMPLATES_MOBILE
?></legend>
               <textarea class="code"
                         name="mobile_SearchFormTemplate"><?=htmlspecialchars(nc_search::get_setting('mobile_SearchFormTemplate'))
?></textarea>
           </fieldset>

           <fieldset>
               <legend><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_ADVANCED_FORM_TEMPLATE_MOBILE
?></legend>
               <textarea class="code"
                         name="mobile_AdvancedSearchFormTemplate"><?=htmlspecialchars(nc_search::get_setting('mobile_AdvancedSearchFormTemplate'))
?></textarea>
    </fieldset>
               <fieldset>
               <legend><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_FORM_TEMPLATES_RESPONSIVE
?></legend>
               <textarea class="code"
                         name="responsive_SearchFormTemplate"><?=htmlspecialchars(nc_search::get_setting('responsive_SearchFormTemplate'))
?></textarea>
           </fieldset>

           <fieldset>
               <legend><?=NETCAT_MODULE_SEARCH_ADMIN_INTERFACE_ADVANCED_FORM_TEMPLATE_RESPONSIVE
?></legend>
               <textarea class="code"
                         name="responsive_AdvancedSearchFormTemplate"><?=htmlspecialchars(nc_search::get_setting('responsive_AdvancedSearchFormTemplate'))
?></textarea>
    </fieldset>
