...
<div class="log_settings settings">
    <!--<div id="settings_hidden"><b> &#x25BA; <?=NETCAT_MODULE_SEARCH_ADMIN_EVENT_LOG_SETTINGS
?></b></div>-->
    <div id="settings_visible">
        <fieldset>
            <legend><?=NETCAT_MODULE_SEARCH_ADMIN_EVENT_LOG_SETTINGS
?></legend>
...
<script type="text/javascript">
    (function() {
        var off = jQuery('#settings_hidden'),
        on = jQuery('#settings_visible'),
...
<?php
                ...
                if ($num_rows) {
                    ...
                    echo "<table class='list log_entries'>\n",
                    "<tr>",
                    ...
                    foreach ($entries as $row) {
                        echo "<tr><td class='nobr'>", $row['Timestamp'], "</td><td>", $row['Type'],
