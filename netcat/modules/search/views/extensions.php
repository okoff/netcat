...
?>
    ...
    <form method="POST" action="?view=extensions_confirm_delete" onsubmit="return (jQuery('input:checked').size() > 0)">
        <table class="list">
            <tr align="left">
                <th><?=NETCAT_MODULE_SEARCH_ADMIN_EXTENSION_INTERFACE
?></th>
...
?></th>
            <!-- <th><?=NETCAT_MODULE_SEARCH_ADMIN_EXTENSION_CONTENT_TYPE
?></th> -->
            <th align="center"><?=NETCAT_MODULE_SEARCH_ADMIN_EXTENSION_PRIORITY ?></th>
        ...
        foreach ($extensions as $e) {
            ...
            "<td align='center'>{$e->get('priority')}</td>",
            "<td align='center'><a href='?view=extensions_edit&amp;id=$id'>", "<div class='icons icon_pencil' title='".NETCAT_MODULE_SEARCH_ADMIN_EDIT."'></div>", "</a></td>",
