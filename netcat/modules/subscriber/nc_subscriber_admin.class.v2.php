...
class nc_subscriber_admin {
    ...
    public function mailer_list() {
      ...
      <table border='0' cellpadding='0' cellspacing='0' width='100%'>
        <tr><td >
            <table class='admin_table' width='100%'>
              <tr>
                ...
                <td  align='center'><div class='icons icon_type_bool'></div></td>
                </tr>";
        ...
        foreach ($mailers as $mailer) {
            ...
            "<td  align='center'><input type='checkbox' name='mailer_".$mailer['Mailer_ID']."' value='".$mailer['Mailer_ID']."' /></td>\n".
            "</tr>";
        }
        echo "
    ...
    public function mailer_form($mailer_id = 0) {
        ...
        echo "<form name='main' id='main' method='post'  action='admin.php' style='padding:0; margin:0;' >\n".
        "<!-- Основные настройки -->".
      ...
      <fieldset>
       <legend>".NETCAT_MODULE_SUBSCRIBER_MAIN_SETTINGS."</legend>\n";
        ...
        echo "<div id='specOff' style='cursor: pointer;' onclick='this.style.display=\"none\";document.getElementById(\"specOn\").style.display=\"\";'>
      ...
      <div id='specOn' style='display: none'>";
       ...
       ".NETCAT_MODULE_SUBSCRIBER_MAILER_PERIOD.": <br/>".
        ...
        echo "<div id='condOff' style='cursor: pointer;' onclick='this.style.display=\"none\";document.getElementById(\"condOn\").style.display=\"\";'>
     ...
     <fieldset>\n".
        ...
        echo "</fieldset></div>\n
     <div id='tempOff' style='cursor: pointer;' onclick='this.style.display=\"none\";document.getElementById(\"tempOn\").style.display=\"\";'>
    ...
    public function sbs_show($mailer_id) {
      ...
      <table border='0' cellpadding='0' cellspacing='0' width='100%'>
        ...
        foreach ($subscriptions as $sbs) {
            ...
            "<td >".$sbs['Status']."</td>\n".
            "<td  align='center'>
                <input type='checkbox' name='sbs_".$sbs['ID']."' value='".$sbs['ID']."' />
              </td>\n".
            "</tr>";
        }
        ...
        <tr><td >
            <table border='0' cellpadding='4' cellspacing='1' width='100%'>
              <tr>
                ...
                <td  width='10%' align='center'><div class='icons icon_type_bool'></div></td>
              </tr>";
    ...
    protected function _textarea($disc, $name, $value, $is_resizeble = 0, $editor = 0) {
        ...
        echo "<div style='margin:10px 0; _padding:0;'>\n".$disc.": <br/>";
        if ($editor) {
            $editor_path = $system_env['EditorType'] == NC_FCKEDITOR ? "editors/FCKeditor/neditor.php" : "editors/ckeditor/neditor.php";
            echo "<button type='button' onclick=\"window.open('".$this->core->SUB_FOLDER.$this->core->HTTP_ROOT_PATH.$editor_path."?form=main&control=".$name."', 'Editor', 'width=750,height=605,resizable=yes,scrollbars=no,toolbar=no,location=no,status=no,menubar=no');\">".TOOLS_HTML_INFO."</button><br>";
        }
        if ($is_resizeble) {
