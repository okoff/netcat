...
define("CONTROL_CONTENT_SUBDIVISION_INDEX_ERROR_THREE_KEYWORD", "Введено недопустимое ключевое слово!");
define("CONTROL_CONTENT_SUBDIVISION_INDEX_ERROR_THREE_KEYWORD_INVALID", "Ключевое слово может содержать только латинские буквы, цифры, дефис и знак подчеркивания! Цифры должны совмещаться с буквами.");
...
define("CONTROL_CONTENT_SUBDIVISION_SUBCLASS_ERROR_KEYWORD_INVALID", "Ключевое слово может содержать только буквы, цифры, нижнее подчеркивание и дефис! Цифры должны совмещаться с буквами.");
define("CONTROL_CONTENT_SUBDIVISION_SUBCLASS_ERROR_KEYWORD", "Введено недопустимое ключевое слово!");
...
define("CONTROL_CONTENT_SUBDIVISION_SEO_VALUE_NOT_SETTINGS", "Значение %s на странице отличное от того, что Вы вводили. <a target='_blank' href='http://netcat.ru/adminhelp/%s'>Подробнее</a>.");
...
define("CONTROL_CONTENT_SUBCLASS_MULTI_NONE", "не выводить");
...
define("NETCAT_MODERATION_INFO_AGREE", "Необходимо согласие на обработку и хранение персональных данных.");
define("NETCAT_MODERATION_INFO_REQFIELDS", "Звездочкой (*) отмечены поля, обязательные для заполнения.");
define("NETCAT_MODERATION_INFO_REQTOWN", "Необходимо выбрать город из списка.");
define("NETCAT_MODERATION_INFO_CARTEMPTY", "Выбранный товар на данный момент отсуствует на складе.");
define("NETCAT_MODERATION_INFO_RF", "Доставка осуществляется только по России.");
define("NETCAT_MODERATION_INFO_SNG", "Доставка осуществляется только по странам СНГ.");
define("NETCAT_MODERATION_INFO_TOWNNOTDLV", "В этот город не осущетсвляется доставка СДЭК.");
define("NETCAT_MODERATION_INFO_DELIVERY_PP", "Необходимо выбрать Постамат.");
define("NETCAT_MODERATION_INFO_DELIVERY_PPpay", "Доставка в Постамат возможна только по предоплате.");
define("NETCAT_MODERATION_INFO_DELIVERY_CDEKpay", "Доставка СДЭК возможна только по предоплате.");
define("NETCAT_MODERATION_SAVE_ORDER", "Спасибо за заказ! Наш менеджер свяжется с Вами в ближайшее время!");
...
define("NETCAT_MODERATION_MSG_NEED_AGREED", "Необходимо согласиться с офертой предоставления услуг и положением о защите персональных данных");
...
# FAVORITE
## HEADER TEXT
define("FAVORITE_HEADERTEXT", "Быстрое редактирование");
...
define('TITLE_OLD', 'Обычный шаблон 4.0');
