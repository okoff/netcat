...
function chn_redaction (event) {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            removeHandler(docum.getElementById(Flied[i]), Action[j], chn_redaction );
        }
    }
...
function remind_add () {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            addHandler(docum.getElementById(Flied[i]), Action[j], chn_add );
        }
    }
...
function chn_add (event) {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            removeHandler(docum.getElementById(Flied[i]), Action[j], chn_add );
        }
    }
...
function remind_edit () {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            addHandler(docum.getElementById(Flied[i]), Action[j], chn_edit );
        }
    }
...
function chn_edit (event) {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            removeHandler(docum.getElementById(Flied[i]), Action[j], chn_edit );
        }
    }
...
function remind_delete () {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            addHandler(docum.getElementById(Flied[i]), Action[j], chn_delete );
        }
    }
...
function chn_delete (event) {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            removeHandler(docum.getElementById(Flied[i]), Action[j], chn_delete );
        }
    }
...
function remind_search () {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            addHandler(docum.getElementById(Flied[i]), Action[j], chn_search );
        }
    }
...
function chn_search (event) {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            removeHandler(docum.getElementById(Flied[i]), Action[j], chn_search );
        }
    }
...
function remind_subscrib () {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            addHandler(docum.getElementById(Flied[i]), Action[j], chn_subscrib );
        }
    }
...
function chn_subscrib (event) {
    ...
    for (i = 0; i < Flied.length; i++) {
        for (j = 0; j < Action.length; j++) {
            removeHandler(docum.getElementById(Flied[i]), Action[j], chn_subscrib );
        }
    }
