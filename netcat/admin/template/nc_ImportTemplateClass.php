...
class nc_ImportTemplate {
    ...
    public function showTplList(&$UI_CONFIG, $fs) { 
        ...
        echo "<form id='adminForm' method='post'>";
    ...
    private function printTplByRow(&$data, $node_id, $level = 0)
    {
        ...
        if (0 != $level) {            
            ...
            echo "name='upload_from' value='".$data[$node_id]['id']."'></td>
                  <td style='padding-left:".($level*10)."px; font-weight: bold;' class='withBorder'><img width='14' border='0' height='10' alt='arrow' src='/netcat/admin/images/arrow_sec.gif'><span>".$data[$node_id]['id'].". </span>".$data[$node_id]['desc']."</td>                  
                  </tr></tbody></table>";
        } 
