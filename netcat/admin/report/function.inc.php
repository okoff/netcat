...
function nc_report_status() {
	...
	$gpc_magic_quotes = ini_get('gpc_magic_quotes');
	...
	$html = "<br style='clear:both;'/><br />
	  ...
	  <div class='reportstatus'>
		...
		<div style='clear:both;'></div>
		<div class='name'>gpc_magic_quotes</div>
		<div class='value'>".($gpc_magic_quotes ? NETCAT_MODERATION_ISON : NETCAT_MODERATION_ISOFF) . "</div>
		<div class='req'>" . ($gpc_magic_quotes ? $error : $ok) . "</div>
		<div style='clear:both;'></div>
