...
function SendMessage($PermissionGroupID, $Subject, $Message, $Attach) {
...
switch ($phase) {
    ...
    case 2:
        ...
        if (isset($Attach)) {
            ...
            BeginHtml($Title2, $Title3, "http://".$DOC_DOMAIN."/management/messages/");
            $perm->ExitIfNotAccess(NC_PERM_ITEM_GROUP, NC_PERM_ACTION_MAIL, 0, 0, 1);
            SendMessage($PermissionGroupID, $Subject, $Message, 0);
        }
        break;
    ...
    case 3:
        ...
        SendMessage($PermissionGroupID, $Subject, $Message, 1);
        break;
}
EndHtml();
?>