 ...
 * настройки раздела
 */
class ui_config_subdivision_settings extends ui_config_subdivision_gereric {
     ...
     * @param boolean
     */
    function updateTreeSubdivisionNode($node_id="", $node_name="", $checked=null) {
...
class ui_config_subdivision_info extends ui_config_subdivision_gereric {
...
class ui_config_subdivision_subclass extends ui_config_subdivision_gereric {
...
class ui_config_subdivision_preview extends ui_config_subdivision_gereric {
