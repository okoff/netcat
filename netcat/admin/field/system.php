...
<?php
	...
	foreach ($Result as $Array) {
		...
		print "<td><a href=\"" . $ADMIN_PATH . "field/index.php?fs=" . +$_REQUEST['fs'] . "&isSys=1&amp;SystemTableID=" . $Array[0] . "&fs=".+$_REQUEST['fs']."\">" . $Array[7] . " ".mb_strtolower( plural_form($Array[7], CONTROL_CLASS_FIELD, CONTROL_CLASS_FIELDS, CONTROL_CLASS_FIELDS_COUNT) )."</a></td>\n";
		print "</tr>";
	}
?>
				</table>
