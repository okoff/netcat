        ...
        <form method=post action=redirect.php>
            ...
            <table class='admin_table' width=100%>
                <tr>
                    ...
                    <th class='align-center'><?= TOOLS_REDIRECT_HEADER ?></th>
                    <th class='align-center'><?= TOOLS_REDIRECT_SETTINGS ?></th>
                ...
                foreach ($Result as $Array) {
                    ...
                    print "<td>" . $Array[2] . "</td>";
                    print "<td class='align-center'>" . ($Array[3] ? $Array[3] : 301) . "</td>";
                    print "<td class='align-center'><a href=redirect.php?phase=1&RedirectID=" . $Array[0] . "><div class='icons icon_settings' title='" . TOOLS_REDIRECT_CHANGEINFO . "'></div></a></td>";
                    print "<td class='align-center'>" . nc_admin_checkbox_simple("Delete" . $Array[0], $Array[0]) . "</td>";
                    print "</tr>";
                }
